...
bool FileManager::ReadMapFile(const string myFile)
{
	...
	if (file.is_open())
	{
		while (getline(file, data))
		{
			...
			if (temp->GetName() == "Turret_Top")
			{
				temp->InitLOD("Turret_Top", "Turret_Top_Mid", "Turret_Top_Lo");
			}
			if (temp->GetName() == "Turret_Bottom")
			{
				temp->InitLOD("Turret_Bottom", "Turret_Bottom_Mid", "Turret_Bottom_Lo");
			}
